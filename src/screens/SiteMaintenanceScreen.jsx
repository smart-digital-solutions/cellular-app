...
const SiteMaintenanceScreen = ({ title, message }) => {
  return (
    <div className="min-h-screen text-right relative flex flex-col items-center justify-center overflow-hidden bg-slate-50 dark:bg-[#0B1120]" dir="rtl">
      ...
      <div className="relative z-10 max-w-2xl w-full px-4">
        <div className="bg-white/80 dark:bg-[rgba(15,23,42,0.6)] backdrop-blur-2xl rounded-[2.5rem] shadow-xl dark:shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] border border-slate-200 dark:border-white/10 p-10 md:p-16 text-center transform transition-all hover:scale-[1.01] duration-500 relative overflow-hidden">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-800 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-white dark:via-slate-200 dark:to-slate-400 mb-6 drop-shadow-sm tracking-tight">
            {title || 'האתר בשידרוגים'}
          </h1>
          
          <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl leading-relaxed mb-10 max-w-lg mx-auto font-medium whitespace-pre-wrap">
            {message || 'אנו עורכים כעת עדכוני מערכת. נשוב לפעילות בהקדם. עמכם הסליחה.'}
          </p>

          <div className="inline-flex flex-col items-center">
            <div className="flex items-center gap-3 px-6 py-3 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl shadow-inner backdrop-blur-md">
              ...
              <span className="text-slate-800 dark:text-cyan-50 font-bold tracking-wide text-sm">
                משדרגים את החוויה...
              </span>
            </div>
