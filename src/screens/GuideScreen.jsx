  ...
  <div className="space-y-8 animate-in fade-in duration-700 relative z-10 max-w-6xl mx-auto" style={{ color: 'var(--clr-text-1)' }}>
    ...
    <section className="grid grid-cols-1 lg:grid-cols-3 gap-5">
      <div className="lg:col-span-1 premium-glass rounded-[2rem] border p-6 flex flex-col transition-shadow duration-300 hover:shadow-2xl" style={{ borderColor: 'var(--clr-border)' }}>
        ...
        <ul className="space-y-4 flex-grow">
          <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-slate-700 dark:text-slate-400 shrink-0 mt-1" /><span className="font-medium text-sm" style={{ color: 'var(--clr-text-2)' }}>שירות קו בלבד ללא סים פיזי, ב-11.06 ₪ לחודש.</span></li>
          ...
          <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-slate-700 dark:text-slate-400 shrink-0 mt-1" /><span className="font-medium text-sm" style={{ color: 'var(--clr-text-2)' }}>אפשרות לשירות תיקונים מקיף למכשיר פרטי בתוספת 7.06 ₪.</span></li>
        </ul>
      ...
      <div className="lg:col-span-2 relative rounded-[2rem] bg-white/90 dark:bg-[#0B1120] p-6 sm:p-10 flex flex-col h-full shadow-xl dark:shadow-2xl border border-slate-200 dark:border-white/10 transition-colors duration-300">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 flex-grow">
          ...
          <li className="flex items-start gap-3"><div className="p-1.5 rounded-full bg-cyan-100 dark:bg-cyan-500/20 shrink-0 mt-0.5"><Globe2 className="w-4 h-4 text-cyan-600 dark:text-cyan-400" /></div><span className="text-slate-800 dark:text-slate-200 text-sm">חבילת חו&quot;ל מובנית: 10GB בחודש + 50 דק&apos;/הודעות</span></li>
    ...
    <section className="grid grid-cols-1 md:grid-cols-3 gap-5">
      <div className="premium-glass rounded-[1.5rem] border p-6 flex flex-col transition-shadow duration-300 hover:shadow-2xl hover-lift" style={{ borderColor: 'var(--clr-border)' }}>
        <h4 className="font-black text-lg mb-3 flex items-center gap-2"><Phone className="w-5 h-5 text-indigo-500" /> ליסינג כשר</h4>
      ...
      <div className="premium-glass rounded-[1.5rem] border p-6 flex flex-col transition-shadow duration-300 hover:shadow-2xl hover-lift" style={{ borderColor: 'var(--clr-border)' }}>
        <h4 className="font-black text-lg mb-3 flex items-center gap-2"><ShieldAlert className="w-5 h-5 text-emerald-500" /> שירות מוגן "נתיב"</h4>
      ...
      <div className="premium-glass rounded-[1.5rem] border p-6 flex flex-col transition-shadow duration-300 hover:shadow-2xl hover-lift" style={{ borderColor: 'var(--clr-border)' }}>
        <h4 className="font-black text-lg mb-3 flex items-center gap-2"><Watch className="w-5 h-5 text-cyan-500" /> תוספות לקו</h4>
    ...
    <section className="relative rounded-[2rem] overflow-hidden shadow-xl bg-slate-50 dark:bg-[#0B1120] border border-cyan-200 dark:border-cyan-900/30 p-6 sm:p-10 transition-all duration-300 hover:shadow-2xl hover-lift">
      <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-cyan-100 dark:bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 font-bold text-xs mb-5 border border-cyan-200 dark:border-cyan-500/20"><Globe2 className="w-3.5 h-3.5" /> מידע למשתמש בחו"ל</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <div className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-5 shadow-sm dark:shadow-none">
          <div className="p-2.5 rounded-xl bg-cyan-100 dark:bg-cyan-500/20 w-fit mb-3"><Ban className="w-5 h-5 text-cyan-600 dark:text-cyan-400" /></div>
        ...
        <div className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-5 shadow-sm dark:shadow-none">
          <div className="p-2.5 rounded-xl bg-indigo-100 dark:bg-indigo-500/20 w-fit mb-3"><Globe2 className="w-5 h-5 text-indigo-600 dark:text-indigo-400" /></div>
